...
#
# run_led.tcl: Tcl script for re-creating project 'run_led'
#
# Generated by Vivado on Mon Oct 02 14:36:40 +0800 2023
...
#
# 1. This project restoration tcl script (run_led.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/OneDrive - zju.edu.cn/fpga/learn/run_led/run_led.srcs/sources_1/new/decoder_3_8.v"
#    "D:/OneDrive - zju.edu.cn/fpga/learn/run_led/run_led.srcs/sources_1/new/run_led_2.v"
#    "D:/OneDrive - zju.edu.cn/fpga/learn/run_led/run_led.srcs/sources_1/new/run_led_1.v"
#    "D:/OneDrive - zju.edu.cn/fpga/learn/run_led/run_led.srcs/sources_1/new/run_led.v"
#    "D:/OneDrive - zju.edu.cn/fpga/learn/run_led/run_led.srcs/sources_1/new/run_led_3.v"
#    "D:/OneDrive - zju.edu.cn/fpga/learn/run_led/run_led.srcs/constrs_1/new/run_led.xdc"
#    "D:/OneDrive - zju.edu.cn/fpga/learn/run_led/run_led.srcs/sim_1/new/tb_run_led.v"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/run_led.srcs/sources_1/new/decoder_3_8.v"]"\
 "[file normalize "$origin_dir/run_led.srcs/sources_1/new/run_led_2.v"]"\
 "[file normalize "$origin_dir/run_led.srcs/sources_1/new/run_led_1.v"]"\
 "[file normalize "$origin_dir/run_led.srcs/sources_1/new/run_led.v"]"\
 "[file normalize "$origin_dir/run_led.srcs/sources_1/new/run_led_3.v"]"\
 "[file normalize "$origin_dir/run_led.srcs/constrs_1/new/run_led.xdc"]"\
 "[file normalize "$origin_dir/run_led.srcs/sim_1/new/tb_run_led.v"]"\
  ]
  foreach ifile $files {
...
set_property -name "top" -value "run_led_2" -objects $obj
...
set file "[file normalize "$origin_dir/run_led.srcs/constrs_1/new/run_led.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/run_led.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *new/run_led.xdc]" -objects $obj
set_property -name "target_part" -value "xc7a100tfgg484-2" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/run_led.xdc]" -objects $obj
...
set_property -name "top" -value "tb_run_led" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a100tfgg484-2 -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/run_led.srcs/utils_1/imports/synth_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a100tfgg484-2 -flow {Vivado Implementation 2021} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/run_led.srcs/utils_1/imports/impl_1" -objects $obj
